...
var riddle = [
  {
    ...
    taskAnswer: ["7-15", "20-15","2-3-1 2-10-15-3-11","A 6-12-15-1-18",  "6-E"]
  },
  {
    quiz: [
    ...
    taskAnswer: [ "6-E","7-15","A 6-12-15-1-18", "20-15", "2-3-1 2-10-15-3-11"]
  },
  {
    quiz: [
    ...
    quizAnswer: ["Global Positioning System", "Venmo", "2009", "1950", "1990"],
    task: [
    ...
    taskAnswer: ["20-15","2-3 1-2-10-15-3-11","7-15", "6-E", "A 6-12-15-1-18",  ]
  },
  {
    quiz: [
    ...
    taskAnswer: ["2-3-1 2-10-15-3-11", "A 6-12-15-1-18","6-E", "7-15","20-15",]
  },
  {
    quiz: [
    ...
    taskAnswer: [ "A 6-12-15-1-18", "6-E","20-15","2-3 1-2-10-15-3-11", "7-15" ]
  },
  {
    quiz: [
